...
def criar_banco_de_dados():
    conexao = sqlite3.connect("bancopacientes.db")
...
def cadastrar_analista(nome, cpf, data_nascimento, registro):
    conexao = sqlite3.connect("bancopacientes.db")
    cursor = conexao.cursor()
    
    cursor.execute(""" INSERT INTO analistas (nome_analista, cpf_analista, data_nascimento, registro) VALUES (?, ?, ?, ?) """, (nome, cpf, data_nascimento, registro))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if opcao == '1':
            ...
            cadastrar_analista(nome, cpf, data_nascimento, registro)
